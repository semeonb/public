...
df = pd.DataFrame([[31.930203, 35.333588, datetime(2019, 1, 1, 12, 0, 0)],
                   ...
                   [31.930203, 35.333588, datetime(2019, 1, 1, 12, 0, 3)],
                   [31.930203, 35.333188, datetime(2019, 5, 1, 12, 2, 4)],
                   [31.930203, 35.333588, datetime(2019, 1, 1, 12, 2, 5)],
                   [31.930203, 35.533588, datetime(2019, 1, 1, 12, 2, 6)],
                   [31.930203, 35.633588, datetime(2019, 1, 1, 12, 5, 7)]],
                  columns=['lat', 'lon', 'ts'])
